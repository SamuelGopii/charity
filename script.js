...
if(window.outerWidth<321){
    ...
    hero_Btns.classList.remove('hero-content-buttons');
    What_we_do_donate_btn.classList.remove('What-we-do-donate-btn-visible');
    help_section_h2.classList.remove('help-section-visible')
